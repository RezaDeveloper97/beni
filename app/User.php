    ...
    CanResetPasswordContract
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'family', "meli_code", 'email', 'password', 'role_id'];
    ...
    public function realAddress(){
        return $this->hasMany('\App\UsersRealAddress',"users_id")->with("ostans","cities");
    }

    public function legalAddress(){
        return $this->hasMany('\App\UsersLegalAddress',"users_id")->with("ostans","cities");
    }
}
