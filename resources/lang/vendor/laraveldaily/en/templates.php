...
return [
  ...
  'templates-view_create-add_new' => 'افزدون',
  'templates-view_create-create' => 'ایجاد',

  // templates-view_create
  'templates-view_edit-edit' => 'ویرایش',
  'templates-view_edit-update' => 'بروزرسانی',
  'templates-view_edit-cancel' => 'لغو',

  // templates-view_index
  'templates-view_index-add_new' => 'افزودن',
  'templates-view_index-list' => 'لیست',
  'templates-view_index-edit' => 'ویرایش',
  'templates-view_index-delete' => 'خذف',
  'templates-view_index-delete_checked' => 'حذف انتخاب شده ها',
  'templates-view_index-confirm_deletion2' => 'آیا آیتم های انتخاب شده حذف شوند؟',
  'templates-view_index-no_entries_found' => 'بدون آیتم.',
  'templates-view_index-are_you_sure' => 'آیا از این عملیات مطمعن هستین؟',
