...
{!! Form::model($collections, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array('admin.collections.update', $collections->id))) !!}
...
<div class="col-sm-9">
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {!! Form::select('categories_id', $categories, old('categories_id',$collections->categories_id), array('class'=>'form-control select2')) !!}
            <p class="help-block">در کدام دسته بندی</p>
        </div>
    </div><div class="form-group">
        {!! Form::label('title', trans("global.title").' *', array('class'=>'col-sm-2 control-label')) !!}
        <div class="col-sm-10">
            {!! Form::text('title', old('title',$collections->title), array('class'=>'form-control')) !!}
            <p class="help-block">عنوان کالکشن</p>
        </div>
    </div><div class="form-group">
        {!! Form::label('en_name', trans("global.en_name").' *', array('class'=>'col-sm-2 control-label')) !!}
        <div class="col-sm-10">
            {!! Form::text('en_name', old('en_name',$collections->en_name), array('class'=>'form-control')) !!}
        ...
        <div class="col-sm-10">
            {!! Form::textarea('short_desc', old('short_desc',$collections->short_desc), array('class'=>'form-control')) !!}
        ...
        <div class="col-sm-10">
            {!! Form::textarea('slideshow_desc', old('slideshow_desc',$collections->slideshow_desc), array('class'=>'form-control')) !!}
        ...
        <div class="col-sm-10">
            {!! Form::textarea('long_desc', old('long_desc',$collections->long_desc), array('class'=>'form-control ckeditor')) !!}
        ...
        <div class="col-sm-10">
            {!! Form::textarea('footer_desc', old('footer_desc',$collections->footer_desc), array('class'=>'form-control ckeditor')) !!}
...
<div class="col-sm-3">
    <div class="form-group">
        ...
        <div class="col-sm-8">
            {!! Form::text('discount', old('discount',$collections->discount), array('class'=>'form-control')) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <div class="select_media_body">
                ...
                {!! Form::hidden('image', old('image',$collections->image), array('class'=>'form-control','id'=>'image')) !!}
                <div class="btn btn-default img-prev"  data-toggle="tooltip" data-picker="image" title="<img width='120px' src='{{asset($collections->image)}}'>"><i class="fa fa-eye"></i></div>
            </div>
        ...
        <div class="col-sm-8">
            <div class="select_media_body">
                ...
                {!! Form::text('price_list_pdf', old('price_list_pdf',$collections->price_list_pdf), array('id'=>'price_list_pdf','class'=>'form-control','readonly' => 'readonly')) !!}
            </div>
        ...
        <div class="col-sm-8">
            <div class="select_media_body">
                ...
                {!! Form::text('catalog_pdf', old('catalog_pdf',$collections->catalog_pdf), array('id'=>'catalog_pdf','class'=>'form-control','readonly' => 'readonly')) !!}
            </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            {!! Form::checkbox('opportunity', 1, $collections->opportunity == 1) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            {!! Form::checkbox('limited_sales', 1, $collections->limited_sales == 1) !!}
            <p class="help-block">فرصت استثنایی</p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            {!! Form::hidden('is_new','') !!}
            {!! Form::checkbox('is_new', 1, $collections->is_new == 1) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {!! Form::select('coll_related[]', $coll_related, old('coll_related[]',$related), array('class'=>'form-control select2','multiple'=>"true")) !!}
            <p class="help-block">در کدام دسته بندی</p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            {!! Form::text('ordering', old('ordering',$collections->ordering), array('class'=>'form-control')) !!}

        </div>
    </div><div class="form-group">
        {!! Form::label('state', trans("global.state").'', array('class'=>'col-sm-4 control-label')) !!}
        <div class="col-sm-8">
            {!! Form::select('state', $state, old('state',$collections->state), array('class'=>'form-control select2')) !!}
