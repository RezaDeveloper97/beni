...
{!! Form::model($deliverways, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array('admin.deliverways.update', $deliverways->id))) !!}
<div class="col-sm-8">
    <div class="form-group">
        {!! Form::label('title', 'عنوان*', array('class'=>'col-sm-2 control-label')) !!}
        <div class="col-sm-10">
            {!! Form::text('title', old('title',$deliverways->title), array('class'=>'form-control')) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {!! Form::select('ostans_id[]', $ostans, old('ostans_id',$deliverways->ostans()->lists("id")->toArray()), array('class'=>'form-control select2',"multiple" => "multiple")) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {!! Form::textarea('description', old('description',$deliverways->description), array('class'=>'form-control ckeditor')) !!}
...
<div class="col-sm-4">
    ...
    <div class="col-sm-10">
        {!! Form::text('price', old('price',$deliverways->price), array('class'=>'form-control')) !!}
        
    </div>
    </div><div class="form-group">
        {!! Form::label('ordering', 'ترتیب', array('class'=>'col-sm-2 control-label')) !!}
        <div class="col-sm-10">
            {!! Form::text('ordering', old('ordering',$deliverways->ordering), array('class'=>'form-control')) !!}

        </div>
    </div><div class="form-group">
        {!! Form::label('state', 'وضعیت', array('class'=>'col-sm-2 control-label')) !!}
        <div class="col-sm-10">
            {!! Form::select('state', $state, old('state',$deliverways->state), array('class'=>'form-control')) !!}
