...
{!! Form::model($aboutusmenus, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array('admin.aboutusmenus.update', $aboutusmenus->id))) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::select('parent_id', $aboutusmenusNested, old('parent_id',$aboutusmenus->parent_id), array('class'=>'form-control select2')) !!}

    </div>
</div><div class="form-group">
    {!! Form::label('title', trans("global.title").' *', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('title', old('title',$aboutusmenus->title), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('en_name', trans("global.en_name").' *', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('en_name', old('en_name',$aboutusmenus->en_name), array('class'=>'form-control')) !!}
...
<div class="panel panel-default">
    <div class="panel-heading">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                {!! Form::select('extension', config("enums.about_us_menu_extensions"), old('extension',$aboutusmenus->extension), array('class'=>'form-control',"id"=>"extension_name")) !!}
    ...
    <div class="panel-body">
        ...
        <div id="menu_target">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::select('params[target]', ["_self"=>trans("global._self"),"_blank"=>trans("global._blank")], old('params[target]',$aboutusmenus->params->target), array('class'=>'form-control select2')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('ordering', old('ordering',$aboutusmenus->ordering), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('state', trans("global.state").'', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('state', $state, old('state',$aboutusmenus->state), array('class'=>'form-control select2')) !!}
...
<div style="display: none !important;" id="menu_extensions">
    <div id="article">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                {!! Form::select('params[article]', $articles, old('params[article]',isset($aboutusmenus->params->article) ? $aboutusmenus->params->article : null), array('class'=>'form-control')) !!}
    ...
    <div id="external">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                {!! Form::text('params[external]', old('params[external]',isset($aboutusmenus->params->external) ? $aboutusmenus->params->external : null), array('class'=>'form-control')) !!}
            </div>
        </div>
    </div>
    <div id="none">
