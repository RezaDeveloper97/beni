...
{!! Form::open(array('route' => 'admin.ostans.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::select('country_id', $countries, old('country_id'), array('class'=>'form-control select2')) !!}
