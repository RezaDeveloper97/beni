...
{!! Form::model($homemodules, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array('admin.homemodules.update', $homemodules->id))) !!}
...
<div class="form-group">
	...
	<br>
        ...
        {!! link_to_route('admin.homemodules.index', trans('global.back') , null, array('class' => 'btn btn-default')) !!}
	<hr>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('title', old('title',$homemodules->title), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        <div class="select_media_body">
			...
			{!! Form::hidden('image', old('image',$homemodules->image), array('id'=>'image','class'=>'form-control','readonly' => 'readonly')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('description', old('description',$homemodules->description), array('class'=>'form-control ckeditor')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('link_to', trans("global.link_to").'', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('link_to', old('link_to',$homemodules->link_to), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('ordering', trans("global.ordering").'', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('ordering', old('ordering',$homemodules->ordering), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('state', trans("global.state").'', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('state', $state, old('state',$homemodules->state), array('class'=>'form-control select2')) !!}
