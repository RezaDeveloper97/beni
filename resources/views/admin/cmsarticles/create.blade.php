...
{!! Form::open(array('route' => 'admin.cmsarticles.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::select('cmscategories_id', $cmscategories, old('cmscategories_id'), array('class'=>'form-control')) !!}
