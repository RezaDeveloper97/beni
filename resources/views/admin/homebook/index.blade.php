...
<p>
	{!! link_to_route('admin.homebook.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            <table class="table table-striped table-hover table-responsive" id="datatableIndex">
                <thead>
                    <tr>
                        <th width="3%">
            ...
            {!! Form::open(['route' => 'admin.homebook.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
                <input type="hidden" id="send" name="toDelete">
            {!! Form::close() !!}
			
			{!! Form::open(['route' => 'admin.homebook.copy', 'method' => 'post', 'id' => 'copy_section']) !!}
                <input type="hidden" id="sendCopy" name="toCopy">
            {!! Form::close() !!}
			
            {!! Form::open(['route' => 'admin.homebook.updateOrdering', 'method' => 'post', 'id' => 'save_ordering_form']) !!}
