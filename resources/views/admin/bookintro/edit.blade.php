...
{!! Form::model($bookintro, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array('admin.bookintro.update', $bookintro->id))) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('name', old('name',$bookintro->name), array('class'=>'form-control')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('e_name', old('e_name',$bookintro->e_name), array('class'=>'form-control')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('title', old('title',$bookintro->title), array('class'=>'form-control')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('subtitle', old('subtitle',$bookintro->subtitle), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        ...
        {!! Form::textarea('content', old('content',$bookintro->content), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        <div class="select_media_body">
			...
			{!! Form::hidden('image', old('image',$bookintro->image), array('id'=>'image','class'=>'form-control','readonly' => 'readonly')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('full_content', old('full_content',$bookintro->full_content), array('class'=>'form-control','style'=>'direction: ltr;')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::number('ordering', old('ordering',$bookintro->ordering), array('class'=>'form-control')) !!}

    </div>
</div><div class="form-group">
    {!! Form::label('state', trans("global.state").'', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('state', $state, old('state',$bookintro->state), array('class'=>'form-control select2')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('meta_keys', old('meta_keys',$bookintro->meta_keys), array('class'=>'form-control')) !!}

    </div>
</div><div class="form-group">
    {!! Form::label('meta_desc', trans("global.meta_desc").'', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::textarea('meta_desc', old('meta_desc',$bookintro->meta_desc), array('class'=>'form-control')) !!}
