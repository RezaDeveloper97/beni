...
{!! Form::model($usersrealaddress, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array('admin.usersrealaddress.update', $usersrealaddress->id))) !!}

<div class="form-group">
    {!! Form::label('users_id', trans("global.user"), array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('users_id', $users, old('users_id',$usersrealaddress->users_id), array('class'=>'form-control select2')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('name_transferee', trans("global.name_and_family_transferee"), array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('name_transferee', old('name_transferee',$usersrealaddress->name), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('mobile', trans("global.mobile_transferee"), array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('mobile', old('mobile',$usersrealaddress->mobile), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('phone', trans("global.phone_transferee"), array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('phone', old('phone',$usersrealaddress->phone), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('ostans_id', trans("global.ostan_transferee"), array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('ostans_id', $ostans, old('ostans_id',$usersrealaddress->ostans_id), array('class'=>'form-control select2')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('cities_id', trans("global.city_transferee"), array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('cities_id', $cities, old('cities_id',$usersrealaddress->cities_id), array('class'=>'form-control select2')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('address', trans("global.address_transferee"), array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('address', old('address',$usersrealaddress->address), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('postal_code', trans("global.postal_code_transferee"), array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('postal_code', old('postal_code',$usersrealaddress->postal_code), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        ...
        {!! Form::checkbox('default_address', 1, $usersrealaddress->default_address == 1) !!}
