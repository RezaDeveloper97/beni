...
<p>
	{!! link_to_route('admin.intro.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}
...
@endif
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            ...
            {!! Form::open(['route' => 'admin.intro.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
                <input type="hidden" id="send" name="toDelete">
            {!! Form::close() !!}

			{!! Form::open(['route' => 'admin.intro.copy', 'method' => 'post', 'id' => 'copy_section']) !!}
                <input type="hidden" id="sendCopy" name="toCopy">
            {!! Form::close() !!}

            {!! Form::open(['route' => 'admin.intro.updateOrdering', 'method' => 'post', 'id' => 'save_ordering_form']) !!}
