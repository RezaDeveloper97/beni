...
{!! Form::model($collectionitems, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array('admin.collectionitems.update', $collectionitems->id))) !!}
...
<div class="col-sm-9">
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {!! Form::select('collections_id', $collections, old('collections_id',$collectionitems->collections_id), array('class'=>'form-control select2')) !!}
            <p class="help-block">انتخاب کالکشن این آیتم</p>
        </div>
    </div><div class="form-group">
        {!! Form::label('title', trans("global.title").' *', array('class'=>'col-sm-2 control-label')) !!}
        <div class="col-sm-10">
            {!! Form::text('title', old('title',$collectionitems->title), array('class'=>'form-control')) !!}
            <p class="help-block">عنوان این آیتم</p>
        </div>
    </div><div class="form-group">
        {!! Form::label('description', trans("global.description").'', array('class'=>'col-sm-2 control-label')) !!}
        <div class="col-sm-10">
            {!! Form::textarea('description', old('description',$collectionitems->description), array('class'=>'form-control')) !!}
...
<div class="col-sm-3">
    <div class="form-group">
        ...
        <div class="col-sm-8">
            {!! Form::select('amount_default', $amount_default, old('amount_default',$collectionitems->amount_default), array('class'=>'form-control select2')) !!}
        ...
        <div class="col-sm-8">
            {!! Form::text('price', old('price',$collectionitems->price), array('class'=>'form-control')) !!}
        ...
        <div class="col-sm-8">
            <div class="select_media_body">
                ...
                {!! Form::hidden('image', old('image',$collectionitems->image), array('id'=>'image','class'=>'form-control','readonly' => 'readonly')) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <div class="select_media_body">
                ...
                {!! Form::hidden('thumb_image', old('thumb_image',$collectionitems->thumb_image), array('id'=>'thumb_image','class'=>'form-control','readonly' => 'readonly')) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            {!! Form::text('ordering', old('ordering',$collectionitems->ordering), array('class'=>'form-control')) !!}

        </div>
    </div><div class="form-group">
        {!! Form::label('state', trans("global.state").'', array('class'=>'col-sm-4 control-label')) !!}
        <div class="col-sm-8">
            {!! Form::select('state', $state, old('state',$collectionitems->state), array('class'=>'form-control select2')) !!}
