...
<td>{{ trans("global.".$row->state) }}</td>
                            ...
                            <td>
                                {!! link_to_route('admin.news.edit', trans('quickadmin::templates.templates-view_index-edit'), array($row->id), array('class' => 'btn btn-xs btn-info')) !!}
			...
			{!! Form::open(['route' => 'admin.news.copy', 'method' => 'post', 'id' => 'copy_section']) !!}
