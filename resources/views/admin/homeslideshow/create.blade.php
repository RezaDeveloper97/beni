...
{!! Form::open(array('route' => 'admin.homeslideshow.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('js_code', old('js_code'), array('class'=>'form-control')) !!}
