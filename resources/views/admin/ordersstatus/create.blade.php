...
{!! Form::open(array('route' => 'admin.ordersstatus.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <div id="color" class="input-group colorpicker colorpicker-component">
            ...
            <input id="fill" name="color" value="{{ old('color',"#000") }}" class="form-control changingFieldParams colorpickerFill" />
        </div>
    </div>
</div>
<div class="form-group">
